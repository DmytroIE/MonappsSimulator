...
IND_DEQUE_MAX_LEN = 10


class AlarmLog(QWidget):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        SignalManager.add_to_alarm_log.connect(self._update_log)

    def _update_log(self, record: dict) -> None:

        # {"ts": ts, "msg": msg, "type": type, "status": status, "instance": str(instance)}
